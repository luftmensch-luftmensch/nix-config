...
\titlepage % Output the title page
	{\includegraphics[width=\paperwidth]{/home/valentino/Dropbox/latex/backgrounds/background.pdf}} % Code to output the background image, which should be the same dimensions as the paper to fill the page entirely; leave empty for no background image
...
#+LATEX_HEADER: \graphicspath{{/home/valentino/Dropbox/latex/content/img}} % Add Global paths for graphicx
